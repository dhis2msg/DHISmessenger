...
public class SharedPrefs {
    ...
    public static String getXMPPPort(Context context) {
        return context.getSharedPreferences(XMPP_DATA, Context.MODE_PRIVATE).getString(PORT, null);
    }
    public static String getXMPPServer(Context context) {
        return context.getSharedPreferences(XMPP_DATA, Context.MODE_PRIVATE).getString(SERVER, null);
    }
